...
export function ChatInfoMainView({ chat, onClose, setViewMode, starredMessages, allMedia }: ChatInfoMainViewProps) {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 flex items-center justify-between border-b border-gray-100 dark:border-gray-800">
        <h2 className="text-sm font-black uppercase tracking-widest text-gray-500 dark:text-gray-400">Info</h2>
        <button 
          onClick={onClose}
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar">
        <ChatInfoProfile chat={chat} isGroup={isGroup} />

        <ChatInfoDescription description={chat.description} isGroup={isGroup} />

        <ChatInfoMediaPreview allMedia={allMedia} onViewAll={() => setViewMode("media")} />
