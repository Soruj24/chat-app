...
export function MessageActionButtons({
  ...
  return (
    <div className={cn(
      "flex flex-col gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity duration-200 self-center px-1.5",
      ...
      <button 
        ...
        className={cn(
          ...
          showQuickReactions ? "text-blue-500 bg-gray-100 dark:bg-gray-800" : "text-gray-400"
        )}
        title="React"
      >
