      ...
      <div className="flex items-center gap-3">
        <div className="relative w-10 h-10 group cursor-pointer" onClick={onSettingsOpen}>
          {user?.avatar ? (
            ...
            <div className="w-full h-full rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white font-black text-sm shadow-md ring-2 ring-blue-500/20 transition-transform group-hover:scale-105">
              {initials}
            </div>
          )}
